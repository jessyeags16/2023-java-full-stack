...
public class OneToManyExample {
	...
	public static void main(String[] args) {
		...
		customer.setEmployee(e); // you have to set the employee obj to the customer then you can add the
									// customer to the employee and save it
